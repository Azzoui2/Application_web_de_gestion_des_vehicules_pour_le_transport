<?php  session_start(); require('auth.php');
    ...
    $sql= "SELECT * FROM `reservation` WHERE reser_id='$id'"; 
...
if(isset($_POST['email'])) {
 ...
 /*
    ...
    $sql2="SELECT * FROM `chauffeur` WHERE chauff_id='$driver_id'";
    $res2= mysqli_query($connection,$sql2);
    $row2= mysqli_fetch_assoc($res2);
    
    $driver_name=$row2['ch_nom'];
    $driver_mobile=$row2['chmobile'];
    //echo $driver_name;
    //echo $driver_mobile;
...
$update_query="UPDATE `reservation` SET `confirmation`='1',`veh_reg`='$veh_reg',`chauff_id`='$driver_id' WHERE reser_id='$id'; UPDATE `vehicle` SET `veh_available`='1' WHERE veh_reg='$veh_reg';UPDATE `chauffeur` SET `ch_available`='1' WHERE chauff_id='$driver_id'";
    
//$update_query="UPDATE `booking` SET `confirmation`='1' WHERE reser_id='$id'";
//echo $update_query;
