<?php 
    ...
    $sql2= "SELECT * FROM `chauffeur` WHERE ch_available='0'"; 
    //echo $sql;
          ...
          <div class="col-md-3"></div>
           <div class="col-md-6">
              <div class="page-header">
                ...
                <p><strong>Booking Id: </strong><?php echo $row['reser_id']; ?></p> 
                
               
                <p><strong>Customer Name: </strong><?php echo $row['nom']; ?></p> 
               ...
               <form action="sendmail.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Available Drivers</b></span>
                        <select class="form-control" name="chauff_id">
                           <?php
                               while($row2=mysqli_fetch_assoc($res2)) {  ?> 
                            ?>
                            <option><?php echo $row2['chauff_id']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
