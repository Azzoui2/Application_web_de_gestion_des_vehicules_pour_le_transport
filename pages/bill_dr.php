<?php   session_start();
   ...
   $sql="SELECT * FROM chauffeur where username='$user' ";
  ...
  <?php include 'navbar_chauffeur.php';?> 
    ...
    <div class="container">
      <div class="row">
        ...
        <h2 style="padding-left:280px;">Ajouter Factur</h2>
        <hr>

        <form action="storebill_dr.php" method="POST" style="padding-left:100px;">
          
        
        <div class="input-group">
        <span class="input-group-addon"><b>Nom :</b></span>
       
          <input required type="text" class="form-control" name="nom" placeholder="nom" value="<?php echo $driver['username'];?>" require>
        </div> <br>
